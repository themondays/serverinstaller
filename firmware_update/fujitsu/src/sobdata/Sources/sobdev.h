...
#define DEV_NAME     "sobdata"

MODULE_DESCRIPTION("FSC Direct Data");

#undef PDEBUG /* undef it, just in case */
#ifdef _DEBUG_
#  define PDEBUG(fmt, args...) printk( KERN_DEBUG "sobdata: " fmt, ## args)
#  define PWARNING(fmt, args...) printk( KERN_WARNING "sobdata: " fmt, ## args)
#else
