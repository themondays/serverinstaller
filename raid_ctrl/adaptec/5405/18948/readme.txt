...
Adaptec ASR-6405/ASR-6445/ASR-6805/ASR-6405E/ASR-6805E/ASR-6805E R5 Unified Serial Controllers
...
The following information is available in this file:
   ...
   4. Known Limitations
      ...
      4.2  ACU Utility
      4.3  AFU Utility      
      4.4  Creating an Array from the Adaptec Installation DVD
      4.5  SuSE Linux Enterprise Server 10 with Service Pack 2
      4.6  Using the Controller with an Adaptec S50 JBOD Enclosure
      4.7  Hot-adding Disk Drives
      4.8  SuperMicro Disk Drive Enclosures
      4.9  Using the Controller with a Seagate Barracuda 1TB SATA Drive 
      ...
      4.15 Linux Cache Synchronization
      4.16 Listing Devices in VMware ESX 4.0 Console
      4.17 BIOS Hangs When Booting RAID Controller with Batteryless Backup (ZMCP)
      4.18 Updating Firmware on Hitachi HUS1514xxVLS300 SAS drives
      4.19 Installing Windows OS from Direct-Attached Non-DASD Device     
      4.20 maxCache SSD Cache Performance
      4.22 Exceeding 2TB LUN Size on VMware ESX Server 
      4.22 PHY Rate Limitations on Western Digital Hard Drives
      ...
      4.29 SATA 6G Drives Not Detected on Intel and Promise Backplanes
      4.30 Samsung Spinpoint SATA Drives Timeout on I/O Load
      4.31 RAID Array Creation Issue With STEC MACH 8 SSDs 
      4.32 Dual-Port SATA Enclosures
      4.33 Xtore and Xyratex Enclosure Timeout
      4.34 Boot delay with Plextor PX-716SA DVD-ROM Drive
      4.35 Series 6 Controllers Hang on Warm Reboot on Some ASUS Motherboards
      4.36 Rebuild Watermark Lost with Hot-Plugged Enclosure 
      4.37 HDA Mode Reset for Adaptec Series 6 Controllers
   ...
   1.1. Controller & Utility Software
       ...
       - Drivers on this DVD
         ...
         - Windows Drivers 
           ...
           o Windows Server 2008 R2 (all versions including Foundation)
         ...
         - Linux Drivers
           ...
           o Red Hat Enterprise Linux 5.7, IA-32 and x64
           o Red Hat Enterprise Linux 6.1, IA-32 and x64
           ...
           o Fedora Linux 14, 15 IA-32 and x64
...
2. Installation and Setup
  ...
  2.4  Fedora Linux Setup
       ...
       o To avoid a known PCIe Active State Power Management issue under
         Fedora Linux 13 and 14, you must add the OS option 'pcie_aspm=off' 
         in GRUB bootloader file "menu.lst". Follow these steps:
  ...
  2.9  Smartctl Setup on Windows

       This release supports the Smartctl disk-monitoring utility
       on Windows operating systems. Smartctl allows you to monitor
       the SMART devices attached to the RAID controllers in your
       system.
       
       The following forms of Smartctl are supported under Windows 7  
       ...
       For Windows operating systems, Smartctl is distributed as part of
       the Smartmontools utility package. For information about downloading 
       and using Smartmontools, see  
...
4. Known Limitations
  ...
  4.1  Adaptec Series 5 Forward Compatibility
       ...
       Adaptec Series 5 firmware is not forward compatible with newer 
       Adaptec controller models. In a server with two controllers
       on the backplane--a Series 5 in Slot 3 and a Series 6 in
       Slot 5--the system will detect only the Series 5. If the slots
       are reversed, with the Series 6 in the lower slot, both 
       controllers are detected. Additionally, on a PCIe Gen3 backplane,
       with the Series 6 in the lower slot and the Series 5 in the
       upper slot, the Series 5 firmware may crash.
       
  4.2  ACU Utility

       o ACU for DOS is deprecated and no longer supported.
                                      
       o The ACU does not allow you to create an array on a Series 6
         controller without providing a logical device name; the 
  ...
  4.5  SuSE Linux Enterprise Server 10
  
       o SLES 10 cannot be installed on a >2TB array.
       
       o If SLES 10 SP2 is installed on a bootable array with driver
         version 1.1.5-2458, you must add 'aacraid.wwn=1' to the kernel
         boot command line. Alternatively, install the latest aacraid 
         driver. 
  ...
  4.16 Listing Devices in VMware ESX 4.x Console
  ...
  4.21 Exceeding 2TB LUN Size on VMware ESX Server
  ...
  4.36 Rebuild Watermark Lost with Hot-Plugged Enclosure 
       ...
       Disconnecting the enclosure cable while an array rebuild is in
       progress resets the rebuild watermark to 0% complete. The 
       rebuild does not resume from where it left off when the cable 
       is reconnected.
