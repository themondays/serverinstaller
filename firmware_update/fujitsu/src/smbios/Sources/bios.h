...
#include <linux/version.h> /* because of kernel version dependencies */
...
typedef struct smbios_entry_point_struct
{
  ...
  __u8  bcd_revision;
}  __attribute__ ((packed)) smbios_entry_point_struct;
...
typedef struct smbios_struct
{
  ...
  __u16 handle;
  __u8  subtype;
  __u8  more_data[0];      /* ... other fields are structure dependend ... */
...
typedef struct dmibios_table_entry_struct
{
  ...
  __u16 handle;
  __u32 procedure;
}  __attribute__ ((packed)) dmibios_table_entry_struct;
...
typedef struct dmibios_entry_point_struct
{
  __u8  signature[10];
  __u8  revision;
  dmibios_table_entry_struct entry[1];
}  __attribute__ ((packed)) dmibios_entry_point_struct;
...
long smbios_get_struct_length(smbios_struct * struct_ptr);
