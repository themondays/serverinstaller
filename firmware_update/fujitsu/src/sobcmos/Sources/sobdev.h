...
#define DEV_NAME     "sobcmos"

MODULE_DESCRIPTION("FSC Cmos Access");

#undef PDEBUG /* undef it, just in case */
#ifdef _DEBUG_
#  define PDEBUG(fmt, args...) printk( KERN_DEBUG "sobcmos: " fmt, ## args)
#  define PWARNING(fmt, args...) printk( KERN_WARNING "sobcmos: " fmt, ## args)
#else
